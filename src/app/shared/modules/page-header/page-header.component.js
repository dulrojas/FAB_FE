...
var PageHeaderComponent = function () {
    ...
    var PageHeaderComponent = _classThis = /** @class */ (function () {
        function PageHeaderComponent_1() {
            this.heading = __runInitializers(this, _heading_initializers, void 0);
            this.icon = (__runInitializers(this, _heading_extraInitializers), __runInitializers(this, _icon_initializers, void 0));
            __runInitializers(this, _icon_extraInitializers);
        }
        PageHeaderComponent_1.prototype.ngOnInit = function () { };
        return PageHeaderComponent_1;
    }());
    __setFunctionName(_classThis, "PageHeaderComponent");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _heading_decorators = [(0, core_1.Input)()];
        ...
        PageHeaderComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return PageHeaderComponent = _classThis;
}();
