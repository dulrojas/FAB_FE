...
var routes = [
    ...
    {
        path: 'error',
        loadChildren: function () { return Promise.resolve().then(function () { return require('./server-error/server-error.module'); }).then(function (m) { return m.ServerErrorModule; }); }
    },
    {
        path: 'access-denied',
        loadChildren: function () { return Promise.resolve().then(function () { return require('./access-denied/access-denied.module'); }).then(function (m) { return m.AccessDeniedModule; }); }
    },
    { path: 'not-found', loadChildren: function () { return Promise.resolve().then(function () { return require('./not-found/not-found.module'); }).then(function (m) { return m.NotFoundModule; }); } },
