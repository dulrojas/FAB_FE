...
var ChartsModule = function () {
    var _classDecorators = [(0, core_1.NgModule)({
            imports: [common_1.CommonModule, ng2_charts_1.NgChartsModule, charts_routing_module_1.ChartsRoutingModule, shared_1.PageHeaderModule],
            declarations: [charts_component_1.ChartsComponent]
        })];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var ChartsModule = _classThis = /** @class */ (function () {
        function ChartsModule_1() {
        }
        return ChartsModule_1;
    }());
