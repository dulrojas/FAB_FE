...
exports.BsComponentModule = void 0;
...
var BsComponentModule = function () {
    var _classDecorators = [(0, core_1.NgModule)({
            imports: [common_1.CommonModule, bs_component_routing_module_1.BsComponentRoutingModule, forms_1.FormsModule, forms_1.ReactiveFormsModule, ng_bootstrap_1.NgbModule, shared_1.PageHeaderModule],
            declarations: [
    ...
    var _classThis;
    var BsComponentModule = _classThis = /** @class */ (function () {
        function BsComponentModule_1() {
        }
        return BsComponentModule_1;
    }());
    __setFunctionName(_classThis, "BsComponentModule");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        BsComponentModule = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return BsComponentModule = _classThis;
}();
