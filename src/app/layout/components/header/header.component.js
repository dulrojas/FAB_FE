...
var HeaderComponent = function () {
    ...
    var HeaderComponent = _classThis = /** @class */ (function () {
        function HeaderComponent_1(translate, router) {
            var _this = this;
        ...
        HeaderComponent_1.prototype.isToggled = function () {
            var dom = document.querySelector('body');
            return dom.classList.contains(this.pushRightClass);
        };
        HeaderComponent_1.prototype.toggleSidebar = function () {
            var dom = document.querySelector('body');
            dom.classList.toggle(this.pushRightClass);
        };
        HeaderComponent_1.prototype.rltAndLtr = function () {
            var dom = document.querySelector('body');
            dom.classList.toggle('rtl');
        };
        HeaderComponent_1.prototype.onLoggedout = function () {
            localStorage.removeItem('isLoggedin');
        };
        HeaderComponent_1.prototype.changeLang = function (language) {
